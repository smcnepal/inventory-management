							...
							<thead>
								...
								<?php foreach ($data as $key) { ?>
									<tr>
										...
										<td> <a class="edit-button" href="<?php echo site_url('admin/Admincontrol/editstock/' . $key->serial_no) ?>"><i class='far fa-edit' style='font-size:20px'></i></a><a class="delete-button" href="<?php echo site_url('admin/Admincontrol/delete_stock/' . $key->serial_no) ?>"><i class='far fa-trash-alt' style='font-size:20px'></i></a> </td>
									</tr>
								<?php } ?>
							</thead>
						</table>
