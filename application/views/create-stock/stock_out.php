<div class="card-body">
    <label style="text-align: center;color:orange;font-family:Lato;font-size:1.5rem;">Stock List</label>
            ...
            <thead>
                ...
                <?php foreach ($data as $key) { ?>
                    <tr>
                        ...
                        <td> <a class="edit-button" href="<?php echo site_url('user/Createstock/editstock_out/' . $key->serial_no) ?>"><i class='far fa-edit' style='font-size:20px'></i></a> </td>
                    </tr>
                <?php } ?>
            </thead>
        </table>
